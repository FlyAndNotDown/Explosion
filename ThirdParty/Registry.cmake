...
find_package(cimg REQUIRED GLOBAL)
...
find_package(swiftshader REQUIRED GLOBAL)

# SwiftShader is a runtime-only package, so Conan's generated targets file does not declare the target named by
# swiftshader_LIBRARIES. Recreate it to carry the runtime files through the existing deployment mechanism.
if (NOT TARGET swiftshader::swiftshader)
    add_library(swiftshader::swiftshader INTERFACE IMPORTED GLOBAL)
endif ()
...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
    ...
    set_target_properties(swiftshader::swiftshader PROPERTIES RUNTIME_DEP "${swiftshader_PACKAGE_FOLDER_RELEASE}/bin/vk_swiftshader.dll;${swiftshader_PACKAGE_FOLDER_RELEASE}/bin/vk_swiftshader_icd.json")
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
    ...
    set_target_properties(swiftshader::swiftshader PROPERTIES RUNTIME_DEP "${swiftshader_PACKAGE_FOLDER_RELEASE}/lib/libvk_swiftshader.dylib;${swiftshader_PACKAGE_FOLDER_RELEASE}/lib/vk_swiftshader_icd.json")
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    set_target_properties(swiftshader::swiftshader PROPERTIES RUNTIME_DEP "${swiftshader_PACKAGE_FOLDER_RELEASE}/lib/libvk_swiftshader.so;${swiftshader_PACKAGE_FOLDER_RELEASE}/lib/vk_swiftshader_icd.json")
endif ()
