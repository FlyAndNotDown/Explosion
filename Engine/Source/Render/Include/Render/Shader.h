...
#define ShaderTypeInfo(inClass, inName, inStage, inSourceFile, inEntryPoint) \
    public: \
        \
...
#define VertexFactoryTypeInfo(inClass, inName, inSourceFile) \
    public: \
        \
        static const inClass& Get(); \
        \
    private: \
        friend class StaticVertexFactory<inClass>; \
        \
        static constexpr const char* name = inName; \
        static constexpr const char* sourceFile = inSourceFile; \

#define DeclVertexFactoryInput(inType, inName, inFormat, inOffset) \
    struct inType { \
        static constexpr const char* name = inName; \
...
#define MakeVertexFactoryInputVec(...) \
...
namespace Render::Internal {
    ...
    ShaderVariantFieldVec BuildVariantFieldVecFromStatic(std::index_sequence<I...>)
    {
    ...
    template <typename T, size_t... I>
    VertexFactoryInputVec BuildVertexFactoryInputVecFromStatic(std::index_sequence<I...>)
    {
