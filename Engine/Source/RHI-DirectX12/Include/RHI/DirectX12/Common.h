...
namespace RHI::DirectX12 {
    ...
    ECIMPL_BEGIN(VertexFormat, DXGI_FORMAT)
        ...
        ECIMPL_ITEM(VertexFormat::uint32X3, DXGI_FORMAT_R32G32B32_UINT)
    ...
    ECIMPL_BEGIN(PrimitiveTopologyType, D3D12_PRIMITIVE_TOPOLOGY_TYPE)
        ...
        ECIMPL_ITEM(PrimitiveTopologyType::patch, D3D12_PRIMITIVE_TOPOLOGY_TYPE_PATCH)
    ...
    ECIMPL_BEGIN(IndexFormat, D3D12_INDEX_BUFFER_STRIP_CUT_VALUE)
        ECIMPL_ITEM(IndexFormat::uint16, D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_0xFFFF)
        ECIMPL_ITEM(IndexFormat::uint32, D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_0xFFFFFFFF)
        ECIMPL_ITEM(IndexFormat::max, D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_DISABLED)
    ECIMPL_END(D3D12_INDEX_BUFFER_STRIP_CUT_VALUE)
    ...
    ECIMPL_BEGIN(QueryType, D3D12_QUERY_HEAP_TYPE)
        ECIMPL_ITEM(QueryType::occlusion, D3D12_QUERY_HEAP_TYPE_OCCLUSION)
        ECIMPL_ITEM(QueryType::timestamp, D3D12_QUERY_HEAP_TYPE_TIMESTAMP)
    ECIMPL_END(D3D12_QUERY_HEAP_TYPE)

    ECIMPL_BEGIN(QueryType, D3D12_QUERY_TYPE)
        ECIMPL_ITEM(QueryType::occlusion, D3D12_QUERY_TYPE_OCCLUSION)
        ECIMPL_ITEM(QueryType::timestamp, D3D12_QUERY_TYPE_TIMESTAMP)
    ECIMPL_END(D3D12_QUERY_TYPE)

    ECIMPL_BEGIN(ColorSpace, DXGI_COLOR_SPACE_TYPE)
        ECIMPL_ITEM(ColorSpace::srgbNonLinear, DXGI_COLOR_SPACE_RGB_FULL_G22_NONE_P709)
        ECIMPL_ITEM(ColorSpace::hdr10St2084,   DXGI_COLOR_SPACE_RGB_FULL_G2084_NONE_P2020)
    ECIMPL_END(DXGI_COLOR_SPACE_TYPE)
    ...
    FCIMPL_BEGIN(TextureUsageFlags, D3D12_RESOURCE_FLAGS)
        ...
        FCIMPL_ITEM(TextureUsageBits::rwStorageBinding,       D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS)
